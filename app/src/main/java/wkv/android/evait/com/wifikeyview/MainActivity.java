...
public class MainActivity extends AppCompatActivity {
    ...
    private void startRootThread(){
        ...
        rootThread = new Thread(new Runnable() {
            ...
            public void run() {
                ...
                for(int wConfIndex=0; wConfIndex<wConfFiles.length; wConfIndex++) {
                    try {
                        Process process = Runtime.getRuntime().exec("su");
                        ...
                        String cmd = "cat " + wConfFiles[wConfIndex];
                        out.write(cmd.getBytes());
                        out.flush();
                        out.close();
    ...
    public static boolean xmlHasNodeAttribute(Node root, String tag, String attribute){
        return (xmlGetNodeByAttribute(root, tag, attribute) != null) ? true : false;
    }
